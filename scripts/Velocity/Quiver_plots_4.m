...
imshow(I)
hold on
quiver (x_pixgrid,y_pixgrid,u_filtered{frame(1)},v_filtered{frame(1)},1,'y');

% str= sprintf('%s_Quiver_%d.jpeg', 'Dry', frame(1)); 
% saveas(gcf, str);
...
imshow(I)
hold on
quiver (x_pixgrid,y_pixgrid,u_filtered{frame(2)},v_filtered{frame(2)},1,'y');

figure (3)
I=imread(files(frame(3)).name);
imshow(I)
hold on
quiver (x_pixgrid,y_pixgrid,u_filtered{frame(3)},v_filtered{frame(3)},1,'y');

figure (4)
I=imread(files(frame(4)).name);
imshow(I)
hold on
quiver (x_pixgrid,y_pixgrid,u_filtered{frame(4)},v_filtered{frame(4)},1,'y');
